...
**Note: If you already have an older rgbds, you will need to update to 0.5.0-rc1.** Ignore this if you have never installed rgbds before. If a version newer than 0.5.0-rc1 does not work, try downloading 0.5.0-rc1.
