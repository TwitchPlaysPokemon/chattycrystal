...
; HMs Waterfall has replaced the zap cannon flag
...
; Chatty exclusive event flags
	...
	const EVENT_LARRY_IN_BATTLE_TENT
	const EVENT_ONIXTRET_IN_BATTLE_TENT
	const EVENT_CHIQUIRTLE_IN_BATTLE_TENT
	const EVENT_HOOTDUO_IN_BATTLE_TENT
	const EVENT_TOGEKEY_IN_BATTLE_TENT
	const EVENT_HOPPORITA_IN_BATTLE_TENT
	const EVENT_WOOCHUM_IN_BATTLE_TENT
	const EVENT_ROCKET_HIDEOUT_B4F_LIFT_KEY ; 158
	...
	const EVENT_ROCKET_HIDEOUT_B1F_NORMAL_BOX_1
	const EVENT_ROCKET_HIDEOUT_B1F_NORMAL_BOX_2
	const EVENT_ROCKET_HIDEOUT_B1F_NORMAL_BOX_3 ; 160
	const EVENT_ROCKET_HIDEOUT_B1F_NORMAL_BOX_4
	const EVENT_ROCKET_HIDEOUT_B1F_NORMAL_BOX_5
	const EVENT_ROCKET_HIDEOUT_B1F_NORMAL_BOX_6
	const EVENT_ROCKET_HIDEOUT_B1F_GS_BALL
	const EVENT_BEAT_GMMTMT
	const EVENT_BEAT_ROCKET_GRUNTF_6
	const EVENT_ROCKET_HIDEOUT_B3F_PP_UP
	const EVENT_ROCKET_HIDEOUT_B3F_MAX_ETHER ; 168
	const EVENT_ROCKET_HIDEOUT_B2F_UP_GRADE
	const EVENT_ROCKET_HIDEOUT_B2F_RARE_CANDY
	const EVENT_ROCKET_HIDEOUT_B2F_HARD_ROCK
...
; Chatty exclusive trainer flags
...
; Johto people
	...
	const EVENT_DRAGONS_DEN_CLAIR ; 6d8
	...
	const EVENT_REMOVED_4 ; 700
	const EVENT_REMOVED_3
