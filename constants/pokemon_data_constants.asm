...
BASE_PADDING_SIZE EQU 3

; gender ratio constants
GENDER_F0      EQU $00
GENDER_F12_5   EQU $1f
GENDER_F25     EQU $3f
GENDER_F31_25  EQU $4f
GENDER_F50     EQU $7f
GENDER_F75     EQU $bf
GENDER_F100    EQU $fe
GENDER_UNKNOWN EQU $ff
...
FORME_BITMASKS       rw
FORME_ANIMATION      rw
FORME_IDLE_ANIMATION rw

FORME_STRUCT_SIZE    EQU _RS

SHOELAX_FORME EQU 5

	const_def
	const SPECIALDEPOSIT_OK            ; 0
	const SPECIALDEPOSIT_HOLDING_MAIL  ; 1
	const SPECIALDEPOSIT_LAST_MON      ; 2
	const SPECIALDEPOSIT_WRONG_SPECIES ; 3
	const SPECIALDEPOSIT_WRONG_MOVES   ; 4
	const SPECIALDEPOSIT_EGG           ; 5

	const_def
	const SPECIALSTORAGE_CHATOT ; 0
	const SPECIALSTORAGE_UNOWN  ; 1
