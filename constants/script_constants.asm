...
; MoveTutor setval arguments
	...
	const MOVETUTOR_AERIAL_ACE   ;  4
	const MOVETUTOR_CALM_MIND    ;  5
	const MOVETUTOR_CRYSTAL_BOLT ;  6
	const MOVETUTOR_DARK_PULSE   ;  7
	const MOVETUTOR_DAZZLINGLEAM ;  8
	const MOVETUTOR_DRACO_METEOR ;  9
	const MOVETUTOR_DRAGON_PULSE ; 10
	const MOVETUTOR_DRAIN_PUNCH  ; 11
	const MOVETUTOR_ENERGY_BALL  ; 12
	const MOVETUTOR_FOCUS_BLAST  ; 13
	const MOVETUTOR_GRASS_KNOT   ; 14
	const MOVETUTOR_HEAT_WAVE    ; 15
	const MOVETUTOR_IRON_HEAD    ; 16
	const MOVETUTOR_KNOCK_OFF    ; 17
	const MOVETUTOR_NASTY_PLOT   ; 18
	const MOVETUTOR_OVERHEAT     ; 19
	const MOVETUTOR_POISON_JAB   ; 20
	const MOVETUTOR_ROCK_SLIDE   ; 21
	const MOVETUTOR_ROOST        ; 22
	const MOVETUTOR_SCALD        ; 23
	const MOVETUTOR_SHADOW_CLAW  ; 24
	const MOVETUTOR_SIGNAL_BEAM  ; 25
	const MOVETUTOR_SUPERPOWER   ; 26
	const MOVETUTOR_SWORDS_DANCE ; 27
	const MOVETUTOR_THUNDER_WAVE ; 28
	const MOVETUTOR_WILL_O_WISP  ; 29
