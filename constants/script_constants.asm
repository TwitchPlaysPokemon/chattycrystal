...
; MoveTutor setval arguments
	...
	const MOVETUTOR_DARK_PULSE   ;  6
	const MOVETUTOR_DAZZLINGLEAM ;  7
	const MOVETUTOR_DRAGON_PULSE ;  8
	const MOVETUTOR_DRAIN_PUNCH  ;  9
	const MOVETUTOR_HEAT_WAVE    ; 10
	const MOVETUTOR_IRON_HEAD    ; 11
	const MOVETUTOR_KNOCK_OFF    ; 12
	const MOVETUTOR_NASTY_PLOT   ; 13
	const MOVETUTOR_POISON_JAB   ; 14
	const MOVETUTOR_ROCK_SLIDE   ; 15
	const MOVETUTOR_ROOST        ; 16
	const MOVETUTOR_SIGNAL_BEAM  ; 17
	const MOVETUTOR_SUPERPOWER   ; 18
	const MOVETUTOR_SWORDS_DANCE ; 19
	const MOVETUTOR_THUNDER_WAVE ; 20
	const MOVETUTOR_WILL_O_WISP  ; 21
