...
; MoveTutor setval arguments
	...
	const MOVETUTOR_SIGNAL_BEAM  ; 24
	const MOVETUTOR_SUPERPOWER   ; 25
	const MOVETUTOR_SWORDS_DANCE ; 26
	const MOVETUTOR_THUNDER_WAVE ; 27
	const MOVETUTOR_WILL_O_WISP  ; 28
