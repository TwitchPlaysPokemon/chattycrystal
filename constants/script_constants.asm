...
; MoveTutor setval arguments
	...
	const MOVETUTOR_HEAT_WAVE    ; 14
	const MOVETUTOR_IRON_HEAD    ; 15
	const MOVETUTOR_KNOCK_OFF    ; 16
	const MOVETUTOR_NASTY_PLOT   ; 17
	const MOVETUTOR_POISON_JAB   ; 18
	const MOVETUTOR_ROCK_SLIDE   ; 19
	const MOVETUTOR_ROOST        ; 20
	const MOVETUTOR_SIGNAL_BEAM  ; 21
	const MOVETUTOR_SUPERPOWER   ; 22
	const MOVETUTOR_SWORDS_DANCE ; 23
	const MOVETUTOR_THUNDER_WAVE ; 24
	const MOVETUTOR_WILL_O_WISP  ; 25
