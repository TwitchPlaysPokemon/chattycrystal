...
; entries correspond to BATTLEANIMOAMSET_* constants
	...
	dbbw $15,  4, .OAMData_04 ; BATTLEANIMOAMSET_D8
	dbbw $0f,  4, .OAMData_d9 ; BATTLEANIMOAMSET_D9
	dbbw $06,  9, .OAMData_da ; BATTLEANIMOAMSET_DA
	dbbw $17,  4, .OAMData_03 ; BATTLEANIMOAMSET_DB
	dbbw $07,  1, .OAMData_0f ; BATTLEANIMOAMSET_DC
	dbbw $1a,  4, .OAMData_03 ; BATTLEANIMOAMSET_DD
	dbbw $0a,  1, .OAMData_de ; BATTLEANIMOAMSET_DE
	...
	dbbw $0e,  4, .OAMData_e5 ; BATTLEANIMOAMSET_E5
	dbbw $0e,  8, .OAMData_e5 ; BATTLEANIMOAMSET_E6
	dbbw $0e,  4, .OAMData_e7 ; BATTLEANIMOAMSET_E7
	dbbw $0e,  8, .OAMData_e7 ; BATTLEANIMOAMSET_E8
	...
	dbbw $0f,  1, .OAMData_0f ; BATTLEANIMOAMSET_FA
	dbbw $12,  9, .OAMData_c3 ; BATTLEANIMOAMSET_FB
	dbbw $09,  6, .OAMData_93 ; BATTLEANIMOAMSET_FC
	dbbw $12,  6, .OAMData_93 ; BATTLEANIMOAMSET_FD
...
.OAMData_e5:
	...
	dsprite   6, 0,   0, 0, $02, X_FLIP | Y_FLIP
	dsprite   0, 0,  -7, 0, $01, $0
	dsprite   0, 0,   6, 0, $01, X_FLIP | Y_FLIP
	dsprite  -8, 0,   0, 0, $02, $0
	dsprite   7, 0,   0, 0, $02, X_FLIP | Y_FLIP
	dsprite   0, 0,  -8, 0, $01, $0
	dsprite   0, 0,   7, 0, $01, X_FLIP | Y_FLIP
...
.OAMData_f1:
	...
	dsprite   0, 0,  -1, 5, $02, $0
	dsprite   1, 0,  -3, 5, $03, $0
	dsprite   1, 0,  -2, 5, $04, $0
	dsprite   2, 0,  -3, 5, $05, $0
	dsprite  -1, 0,   1, 2, $00, X_FLIP | Y_FLIP
	dsprite  -1, 0,   0, 2, $01, X_FLIP | Y_FLIP
	dsprite  -1, 0,  -1, 2, $02, X_FLIP | Y_FLIP
	dsprite  -2, 0,   1, 2, $03, X_FLIP | Y_FLIP
	dsprite  -2, 0,   0, 2, $04, X_FLIP | Y_FLIP
	dsprite  -3, 0,   1, 2, $05, X_FLIP | Y_FLIP
