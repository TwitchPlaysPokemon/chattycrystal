...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_CD, BATTLEANIMFUNC_18, PAL_BATTLE_OB_GREEN, ANIM_GFX_HORN ; ANIM_OBJ_NEEDLE_ARM_N
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_CE, BATTLEANIMFUNC_18, PAL_BATTLE_OB_GREEN, ANIM_GFX_HORN ; ANIM_OBJ_NEEDLE_ARM_NE
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_CF, BATTLEANIMFUNC_18, PAL_BATTLE_OB_GREEN, ANIM_GFX_HORN ; ANIM_OBJ_NEEDLE_ARM_E
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_D0, BATTLEANIMFUNC_18, PAL_BATTLE_OB_GREEN, ANIM_GFX_HORN ; ANIM_OBJ_NEEDLE_ARM_SE
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_C9, BATTLEANIMFUNC_18, PAL_BATTLE_OB_GREEN, ANIM_GFX_HORN ; ANIM_OBJ_NEEDLE_ARM_S
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_CA, BATTLEANIMFUNC_18, PAL_BATTLE_OB_GREEN, ANIM_GFX_HORN ; ANIM_OBJ_NEEDLE_ARM_SW
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_CB, BATTLEANIMFUNC_18, PAL_BATTLE_OB_GREEN, ANIM_GFX_HORN ; ANIM_OBJ_NEEDLE_ARM_W
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_CC, BATTLEANIMFUNC_18, PAL_BATTLE_OB_GREEN, ANIM_GFX_HORN ; ANIM_OBJ_NEEDLE_ARM_NW
