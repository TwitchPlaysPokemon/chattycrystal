...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_C7, BATTLEANIMFUNC_52, PAL_BATTLE_OB_GRAY, ANIM_GFX_HIT; ANIM_OBJ_VERTICLE_CHOP
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_C7, BATTLEANIMFUNC_09, PAL_BATTLE_OB_GRAY, ANIM_GFX_HIT; ANIM_OBJ_VERTICLE_CHOP_STILL
