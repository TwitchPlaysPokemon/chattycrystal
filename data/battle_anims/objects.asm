...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X | X_FLIP, $a0, BATTLEANIMFRAMESET_1D, BATTLEANIMFUNC_02, PAL_BATTLE_OB_GRAY, ANIM_GFX_POISON ; ANIM_OBJ_MUD_SHOT
	...
	battleanimobj RELATIVE_X | X_FLIP, $a0, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_02, PAL_BATTLE_OB_BROWN, ANIM_GFX_ROCKS ; ANIM_OBJ_ROCK_BLAST
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_C3, BATTLEANIMFUNC_45, PAL_BATTLE_OB_BLUE, ANIM_GFX_CHARGE ; ANIM_OBJ_DARK_PULSE
