...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_7A, BATTLEANIMFUNC_45, PAL_BATTLE_OB_YELLOW, ANIM_GFX_SPEED ; ANIM_OBJ_DAZZLE
	...
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_D2, BATTLEANIMFUNC_00, PAL_BATTLE_OB_GRAY, ANIM_GFX_HIT ; ANIM_OBJ_BULLET_PUNCH
