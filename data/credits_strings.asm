...
.ChattyDevs:          db "   #MON CHATTY"
                    next "  CRYSTAL VERSION"
                    next "    DEVELOPERS@"
.RomDeveloper:        db "   ROM DEVELOPER@"
.ChaosLord2:          db "    Chaos_Lord2@"
.Red031000:           db "     Red031000@"
.FrostedGeulleisia    db " FrostedGeulleisia@"
.ax6                  db "        ax6@"
.GameEngine:          db "    GAME ENGINE@"
.BattleEngine:        db "   BATTLE ENGINE@"
.Fiq:                 db "        FIQ@"
.ProcessingHelp:      db "  PROCESSING HELP@"
.PiaCarrot:           db "     Pia Carrot@"
.Artist:              db "      ARTIST@"
.BloodlessNS:         db "    BloodlessNS@"
.Kelcyus:             db "      Kelcyus@"
...
.Copyright:
	...
	;    (C)  2  0  2  1    T  P  P  D  e  v  s
	next $60,$64,$da,$db,$dc,$dd,$de,$df,$e0,$e1
	db "@"
