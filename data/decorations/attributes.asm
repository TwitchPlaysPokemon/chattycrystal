...
; entries correspond to deco constants
	decoration DECO_PLANT,   $00,            $0,                0,                               $00
	decoration DECO_PLANT,   PUT_IT_AWAY,    PUT_AWAY_BED,      0,                               $00
	...
	decoration DECO_PLANT,   PUT_IT_AWAY,    PUT_AWAY_CARPET,   0,                               $00
	...
	decoration DECO_PLANT,   PUT_IT_AWAY,    PUT_AWAY_PLANT,    0,                               $00
	...
	decoration DECO_PLANT,   PUT_IT_AWAY,    PUT_AWAY_POSTER,   0,                               $00
	...
	decoration DECO_PLANT,   PUT_IT_AWAY,    PUT_AWAY_CONSOLE,  0,                               $00
	...
	decoration DECO_PLANT,   PUT_IT_AWAY,    PUT_AWAY_BIG_DOLL, 0,                               $00
	...
	decoration DECO_PLANT,   PUT_IT_AWAY,    PUT_AWAY_DOLL,     0,                               $00
