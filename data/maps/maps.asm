...
MapGroup_Viridian:
	...
	map TrickHouseEntrance, TILESET_TRADITIONAL_HOUSE, INDOOR, VIRIDIAN_CITY, MUSIC_TRICKHOUSE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TrickHouseExit, TILESET_TRADITIONAL_HOUSE, INDOOR, VIRIDIAN_CITY, MUSIC_TRICKHOUSE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TrickHouseHallway, TILESET_TRADITIONAL_HOUSE, INDOOR, VIRIDIAN_CITY, MUSIC_TRICKHOUSE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TrickHousePuzzle1, TILESET_TRADITIONAL_HOUSE, INDOOR, VIRIDIAN_CITY, MUSIC_TRICKHOUSE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TrickHousePuzzle2, TILESET_TRADITIONAL_HOUSE, INDOOR, VIRIDIAN_CITY, MUSIC_TRICKHOUSE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TrickHousePuzzle3, TILESET_TRADITIONAL_HOUSE, INDOOR, VIRIDIAN_CITY, MUSIC_TRICKHOUSE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TrickHousePuzzle4, TILESET_TRADITIONAL_HOUSE, INDOOR, VIRIDIAN_CITY, MUSIC_TRICKHOUSE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TrickHousePuzzle5, TILESET_TRADITIONAL_HOUSE, INDOOR, VIRIDIAN_CITY, MUSIC_TRICKHOUSE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TrickHousePuzzle6, TILESET_TRADITIONAL_HOUSE, INDOOR, VIRIDIAN_CITY, MUSIC_TRICKHOUSE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
