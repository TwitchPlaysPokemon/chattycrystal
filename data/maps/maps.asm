...
MapGroup_Indigo:
	map Route23, TILESET_ROUTE_23, TOWN, ROUTE_23, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_POND
	...
	map IndigoPlateauOutside, TILESET_ROUTE_23, ROUTE, INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_POND
