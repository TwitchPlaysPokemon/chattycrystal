...
MapGroup_Dungeons:
	...
	map ViridianForest, TILESET_KANTO_FOREST, ROUTE, VIRIDIAN_FOREST, MUSIC_ROUTE_2, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map CeruleanCave1F, TILESET_CAVE, CAVE, CERULEAN_CAVE, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
	map CeruleanCave2F, TILESET_CAVE, CAVE, CERULEAN_CAVE, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
	map CeruleanCaveB1F, TILESET_CAVE, CAVE, CERULEAN_CAVE, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
	map PokemonMansion1F, TILESET_PKMN_MANSION, DUNGEON, POKEMON_MANSION, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map PokemonMansion2F, TILESET_PKMN_MANSION, DUNGEON, POKEMON_MANSION, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map PokemonMansion3F, TILESET_PKMN_MANSION, DUNGEON, POKEMON_MANSION, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map PokemonMansionB1F, TILESET_PKMN_MANSION, DUNGEON, POKEMON_MANSION, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map RocketHideoutB1F, TILESET_PKMN_MANSION, DUNGEON, CELADON_CITY, MUSIC_ROCKET_HIDEOUT, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map RocketHideoutB2F, TILESET_PKMN_MANSION, DUNGEON, CELADON_CITY, MUSIC_ROCKET_HIDEOUT, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map RocketHideoutB3F, TILESET_PKMN_MANSION, DUNGEON, CELADON_CITY, MUSIC_ROCKET_HIDEOUT, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map RocketHideoutB4F, TILESET_PKMN_MANSION, DUNGEON, CELADON_CITY, MUSIC_ROCKET_HIDEOUT, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map RocketHideoutElevator, TILESET_PKMN_MANSION, DUNGEON, CELADON_CITY, MUSIC_ROCKET_HIDEOUT, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map PokemonTower1F, TILESET_CEMETERY, DUNGEON, LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonTower2F, TILESET_CEMETERY, DUNGEON, LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonTower3F, TILESET_CEMETERY, DUNGEON, LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonTower4F, TILESET_CEMETERY, DUNGEON, LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonTower5F, TILESET_CEMETERY, DUNGEON, LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonTower6F, TILESET_CEMETERY, DUNGEON, LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonTower7F, TILESET_CEMETERY, DUNGEON, LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cinnabar:
	...
	map SeafoamIslands1F, TILESET_CAVE, CAVE, SEAFOAM_ISLANDS, MUSIC_MT_MOON, TRUE, PALETTE_DAY, FISHGROUP_DRATINI
	map SeafoamIslandsB1F, TILESET_ICE_PATH, CAVE, SEAFOAM_ISLANDS, MUSIC_MT_MOON, TRUE, PALETTE_DAY, FISHGROUP_DRATINI
	map SeafoamIslandsB2F, TILESET_ICE_PATH, CAVE, SEAFOAM_ISLANDS, MUSIC_MT_MOON, TRUE, PALETTE_DAY, FISHGROUP_DRATINI
	map SeafoamIslandsB3F, TILESET_ICE_PATH, CAVE, SEAFOAM_ISLANDS, MUSIC_MT_MOON, TRUE, PALETTE_DAY, FISHGROUP_DRATINI
	map SeafoamIslandsB4F, TILESET_ICE_PATH, CAVE, SEAFOAM_ISLANDS, MUSIC_MT_MOON, TRUE, PALETTE_DAY, FISHGROUP_DRATINI
...
MapGroup_Indigo:
	map Route23, TILESET_INDIGO_PLATEAU, TOWN, ROUTE_23, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_POND
	...
	map IndigoPlateauOutside, TILESET_INDIGO_PLATEAU, ROUTE, INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_Celadon:
	...
	map BattleTentRuins, TILESET_BATTLE_TOWER, INDOOR, CELADON_CITY, MUSIC_BATTLE_TENT_RUINS, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map BattleTentBattleRoom, TILESET_BATTLE_TOWER, INDOOR, CELADON_CITY, MUSIC_BATTLE_TENT_RUINS, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map BattleTentGenerator, TILESET_BATTLE_TOWER, INDOOR, CELADON_CITY, MUSIC_BATTLE_TENT_RUINS, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map BattleTentPCRoom, TILESET_BATTLE_TOWER, INDOOR, CELADON_CITY, MUSIC_BATTLE_TENT_RUINS, FALSE, PALETTE_NITE, FISHGROUP_NONE
