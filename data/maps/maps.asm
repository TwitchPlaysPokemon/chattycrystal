...
MapGroup_Dungeons:
	...
	map PokemonMansion1F, TILESET_PKMN_MANSION, CAVE, POKEMON_MANSION, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map PokemonMansion2F, TILESET_PKMN_MANSION, CAVE, POKEMON_MANSION, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map PokemonMansion3F, TILESET_PKMN_MANSION, CAVE, POKEMON_MANSION, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map PokemonMansionB1F, TILESET_PKMN_MANSION, CAVE, POKEMON_MANSION, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_NONE
