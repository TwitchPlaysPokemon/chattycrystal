...
Moves1:
	...
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;FAKE_OUT
	...
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;ASSIST
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;SUPERPOWER
	...
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;POISON_FANG
	...
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;OVERHEAT
	move EFFECT_FORESIGHT,            0, NORMAL,   100, 40,   0 ;ODOR_SLEUTH
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;ROCK_TOMB
	move EFFECT_SP_DEF_DOWN_2,        0, STEEL,     85, 40,   0 ;METAL_SOUND
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;TICKLE
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;SIGNAL_BEAM
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;SHADOW_PUNCH
	move EFFECT_FLINCH_HIT,          80, PSYCHIC,  100, 20,  10 ;EXTRASENSORY
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;SAND_TOMB
	...
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;VOLT_TACKLE
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;DRAGON_DANCE
	move EFFECT_ALWAYS_HIT,          60, ELECTRIC, 100, 20,   0 ;SHOCK_WAVE
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;WATER_PULSE
	move EFFECT_ROOST,                0, FLYING,   100, 10,   0 ;ROOST
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;WAKE_UP_SLAP
	move EFFECT_SELF_SPEED_DOWN_HIT,100, FIGHTING,  90, 10, 100 ;HAMMER_ARM
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;BRINE
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;CLOSE_COMBAT
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;ASSURANCE
	move EFFECT_TRUMP_CARD,           1, NORMAL,   100,  5,   0 ;TRUMP_CARD
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;SUCKER_PUNCH
	move EFFECT_AQUA_RING,            0, WATER,      0, 20, 100 ;AQUA_RING
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;FLARE_BLITZ
	...
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;POWER_GEM
	...
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;FIRE_FANG
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;SHADOW_SNEAK
	move EFFECT_ACCURACY_DOWN,       65, GROUND,    85, 10,  30 ;MUD_BOMB
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;PSYCHO_CUT
	move EFFECT_FLINCH_HIT,          70, PSYCHIC,   90, 15,  20 ;ZEN_HEADBUTT
	move EFFECT_SP_DEF_DOWN_HIT,     80, STEEL,    100, 10,  10 ;FLASH_CANNON
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;ROCK_CLIMB
	move EFFECT_PARALYZE_HIT,        80, ELECTRIC, 100, 15,  30 ;DISCHARGE
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;LEAF_STORM
	move EFFECT_FLINCH_HIT,          80, STEEL,    100, 15,  30 ;IRON_HEAD
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;GRASS_KNOT
	...
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;STEAMROLLER
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;TAIL_SLAP
	move EFFECT_BURN_HIT,           120, FIRE,      85, 5,   20 ;BLUE_FLARE
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;FREEZE_DRY
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;DRAININGKISS
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;PLAY_ROUGH
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;MOONBLAST
	move EFFECT_PLACEHOLDER,         40, NORMAL,   100, 10,   0 ;DAZZLINGLEAM
