:	db 0 ; species ID placeholder
	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, HEADBUTT, CURSE, ROAR, TOXIC, ROCK_SMASH, HIDDEN_POWER, SUNNY_DAY, SNORE, HYPER_BEAM, PROTECT, ENDURE, FRUSTRATION, SOLARBEAM, EARTHQUAKE, RETURN, DIG, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, FIRE_BLAST, SWIFT, THUNDERPUNCH, DETECT, REST, ATTRACT, FIRE_PUNCH, FURY_CUTTER, CUT, STRENGTH, FLAMETHROWER, AERIAL_ACE, FOCUS_BLAST, HEAT_WAVE, KNOCK_OFF, OVERHEAT, POISON_JAB, ROCK_SLIDE, SHADOW_CLAW, SUPERPOWER, SWORDS_DANCE, WILL_O_WISP
