...
;	dbbw EVOLVE_ITEM, LEAF_STONE, LEAFEON ; TODO: When Leafeon is added
	dbbw EVOLVE_ITEM, ICE_STONE, GLACEON ; TODO: When ax6 expands the evolution limit or something
;	dbbw EVOLVE_ITEM, MOON_STONE, SYLVEON ; TODO: When Sylveon is added
