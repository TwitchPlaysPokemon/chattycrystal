MonMenuIcons:
	...
	; Fused Crystal mons
	db ICON_SERPENT     ; ONIXTRET
	db ICON_ODDISH      ; CHIQUIRTLE
	db ICON_ODDISH      ; BAYTORTLE
	db ICON_ODDISH      ; MEGASTOISE
	db ICON_BIRD        ; HOOTDUO
	db ICON_BIRD        ; NOCTDRIO
	db ICON_BIRD        ; TOGEKEY
	db ICON_BIRD        ; TOGETAPE
	db ICON_ODDISH      ; HOPPORITA
	db ICON_ODDISH      ; SKIPLEEF
	db ICON_ODDISH      ; JUMPANIUM
	db ICON_MONSTER     ; WOOCHUM
