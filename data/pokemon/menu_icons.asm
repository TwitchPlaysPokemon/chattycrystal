MonMenuIcons:
	...
	db ICON_MONSTER     ; HELIOPTILE
	db ICON_MONSTER     ; HELIOLISK
	db ICON_BIGMON      ; AMAURA
	db ICON_BIGMON      ; AURORUS
	db ICON_FOX         ; SYLVEON
	db ICON_BLOB        ; GOOMY
	db ICON_BLOB        ; SLIGGOO
	db ICON_BIGMON      ; GOODRA
	db ICON_SHELL       ; CRABRAWLER
	db ICON_SHELL       ; CRABOMINABLE
	db ICON_MOTH        ; CUTIEFLY
	db ICON_MOTH        ; RIBOMBEE
	; Fused Crystal mons
	db ICON_FUSION      ; ONIXTRET
	db ICON_FUSION      ; CHIQUIRTLE
	db ICON_FUSION      ; BAYTORTLE
	db ICON_FUSION      ; MEGASTOISE
	db ICON_FUSION      ; HOOTDUO
	db ICON_FUSION      ; NOCTDRIO
	db ICON_FUSION      ; TOGEKEY
	db ICON_FUSION      ; TOGETAPE
	db ICON_FUSION      ; HOPPORITA
	db ICON_FUSION      ; SKIPLEEF
	db ICON_FUSION      ; JUMPANIUM
	db ICON_FUSION      ; WOOCHUM
	db ICON_FUSION      ; QUAGYNX
	db ICON_FUSION      ; STEELURRET
