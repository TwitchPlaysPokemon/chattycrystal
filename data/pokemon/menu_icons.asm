MonMenuIcons:
	...
	db ICON_SHELL       ; SHELLOS
	db ICON_SHELL       ; GASTRODON
	...
	db ICON_FIGHTER     ; PANSAGE
	db ICON_FIGHTER     ; SIMISAGE
	...
	db ICON_SHELL       ; CRABRAWLER
	db ICON_SHELL       ; CRABOMINABLE
