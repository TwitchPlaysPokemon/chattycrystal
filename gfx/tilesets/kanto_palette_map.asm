...
endr
	...
	tilepal 1, ROOF, ROOF, BROWN, ROOF, ROOF, GRAY, BROWN, GRAY
	tilepal 1, GRAY, GRAY, BROWN, BROWN, GRAY, GRAY, ROOF, ROOF
	tilepal 1, ROOF, ROOF, GRAY, ROOF, ROOF, GRAY, BROWN, GRAY
	tilepal 1, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, ROOF, BROWN
	...
	tilepal 1, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY
	tilepal 1, GREEN, GREEN, GREEN, ROOF, BROWN, BROWN, BROWN, GRAY
