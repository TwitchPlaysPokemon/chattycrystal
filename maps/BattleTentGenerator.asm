...
BattleTentGenerator_MapEvents:
	...
	object_event 17,  2, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, BattleTentGeneratorOnixtret, EVENT_ONIXTRET_IN_BATTLE_TENT
	object_event 18,  2, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, BattleTentGeneratorChiquirtle, EVENT_CHIQUIRTLE_IN_BATTLE_TENT
	object_event 19,  2, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, BattleTentGeneratorHootduo, EVENT_HOOTDUO_IN_BATTLE_TENT
	object_event 17,  3, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, BattleTentGeneratorTogekey, EVENT_TOGEKEY_IN_BATTLE_TENT
	object_event 18,  3, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, BattleTentGeneratorHopporita, EVENT_HOPPORITA_IN_BATTLE_TENT
	object_event 19,  3, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, BattleTentGeneratorWoochum, EVENT_WOOCHUM_IN_BATTLE_TENT
