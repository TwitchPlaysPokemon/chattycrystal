...
BurnedTowerB1F_MapEvents:
	...
	object_event  7,  3, SPRITE_RAIKOU, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_INITIALIZED_EVENTS
	object_event 12,  3, SPRITE_SUICUNE, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_INITIALIZED_EVENTS
	object_event 10,  4, SPRITE_ENTEI, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_INITIALIZED_EVENTS
	...
	object_event 10,  2, SPRITE_ENTEI, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, 1, 1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, BurnedTowerB1F_RematchEntei, EVENT_REMATCH_ENTEI
