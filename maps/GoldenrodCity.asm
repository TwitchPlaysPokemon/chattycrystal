...
.TeachMove:
	...
	special DisplayCoinCaseBalance
	jumptext GoldenrodCityMoveTutorComeAgainKidText
...
GoldenrodCityMoveTutorComeAgainKidText:
	text "Wahahah!"
	line "Come again, kid!"
	done
...
GoldenrodCity_MapEvents:
	...
	warp_event 29, 15, GOLDENROD_MOVE_RELEARNER, 1
