...
MountMortar1FInside_MapEvents:
	...
	object_event 35, 38, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, MountMortar1FInsideMoonStone, EVENT_MOUNT_MORTAR_1F_INSIDE_MOON_STONE
