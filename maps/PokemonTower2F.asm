...
PokemonTower2F_MapEvents:
	...
	db 3 ; object events
	object_event  1,  8, SPRITE_EVAN, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 3, ObjectEvent, EVENT_POKEMON_TOWER_2F_EVAN
	object_event  9, 11, SPRITE_GRANNY, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 4, TrainerMediumCarly, -1
