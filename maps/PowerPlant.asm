...
PowerPlant_MapEvents:
	...
	object_event 14, 10, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, PowerPlantManager, EVENT_FOUND_MACHINE_PART_IN_CERULEAN_GYM
