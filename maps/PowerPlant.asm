...
.FoundMachinePart:
	...
	;disappear POWERPLANT_OFFICER3 restore this when opening power plant basement
...
PowerPlant_MapEvents:
	...
	object_event  19,  3, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, PowerPlantOfficer3Script, -1 ;EVENT_RESTORED_POWER_TO_KANTO restore this to open power plant basement
